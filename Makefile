...
release_linux: check_KCC/check_KCC  JUMP_Start_8k/JUMP_Start_8k  JUMP_Start_16k/JUMP_Start_16k  MENU_Start_8k/JUMP_Start_8k  MENU_Start_16k/JUMP_Start_16k
	...
	cp MENU_Start_8k/JUMP_Start_8k   release_linux
	cp MENU_Start_8k/*.rom           release_linux
	cp MENU_Start_16k/JUMP_Start_16k release_linux
	cp MENU_Start_16k/*.rom          release_linux
	cd release_linux; zip -9   ../release_linux__$(RELEASE_NUMBER) *

release_win: check_KCC/check_KCC.exe  JUMP_Start_8k/JUMP_Start_8k.exe  JUMP_Start_16k/JUMP_Start_16k.exe  MENU_Start_8k/JUMP_Start_8k.exe  MENU_Start_16k/JUMP_Start_16k.exe
	mkdir -p release_win
	...
	cp MENU_Start_8k/JUMP_Start_8k.exe   release_win
	cp MENU_Start_8k/*.rom               release_win
	cp MENU_Start_16k/JUMP_Start_16k.exe release_win
