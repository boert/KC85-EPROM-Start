...
release_linux: check_KCC/check_KCC  AUTO_Start/AUTO_Start   JUMP_Start/JUMP_Start  MENU_Start/MENU_Start
...
release_win: check_KCC/check_KCC.exe  AUTO_Start/AUTO_Start.exe   JUMP_Start/JUMP_Start.exe  MENU_Start/MENU_Start.exe
	mkdir -p release_win
